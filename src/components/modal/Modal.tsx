...
function Modal({ active, children, handleClose }: IProps) {
  return (
    <>
      <div
        className={`${
      ...
      >
        <div className="pointer-events-auto mt-28 mx-auto max-w-2xl w-full max-h-64 h-full p-4 rounded-lg bg-secondary">
